 ...
 * @author BIIbr
 */
public class VModificarPokemon extends javax.swing.JInternalFrame {  
    ...
    public static final String BTN_AGREGARTIPOMODIFICACION = "modifica un nuevo tipo";
    public static final String BTN_AGREGARHABILIDADMODIFICACION = "modifica una nueva habilidad";
    public static final String BTN_AGREGAREVOLUCIONMODIFICACION = "modifica una nueva evolucion";
    public static final String BTN_GUARDARMODIFICACION = "modifica pokemon";
    
    
    public VModificarPokemon() {
        initComponents();
    }
    public void ejecutar(ArrayList<String> listaTipo){
        ...
        this.setTitle("Modificar pokemon");
        this.setVisible(true);        
    }
    public void setControlador(Controlador controlador){
        btnAgragarTipo.setActionCommand(BTN_AGREGARTIPOMODIFICACION);
        btnAgregarHabilidad.setActionCommand(BTN_AGREGARHABILIDADMODIFICACION);
        btnAgragarEvolucion.setActionCommand(BTN_AGREGAREVOLUCIONMODIFICACION);
        btnGuardar.setActionCommand(BTN_GUARDARMODIFICACION);
